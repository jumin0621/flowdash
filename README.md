...
FlowDash 프로젝트는 성취감을 시각적으로 느끼고 하루의 흐름을 정리하고 다시 들어오고 싶게 만드는
감성 기반 Todo & 대시보드 서비스라고 할 수 있습니다.
그리고 이 프로젝트를 통해 기능구현/디자인설계/프로젝트 구조개선/GitHub협업/문제해결/팀 커뮤니케이션까지
실제 서비스 개발과 거의 비슷한 과정을 경험할 수 있었습니다. 기술적인 성장뿐만 아니라,
협업 방식과 사용자 관점에서 생각하는 법, 그리고 좋은 팀과 함께라면 더 어려운 것도 해낼 수 있다는 경험을 얻었습니다.
